...
import type { DocumentUri, Diagnostic, TextDocumentPositionParams } from 'vscode-languageserver-protocol';
...
export const PositionContext = React.createContext<TextDocumentPositionParams>(null as any)
